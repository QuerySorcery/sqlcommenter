if Code.ensure_loaded?(Ecto.Repo) do
  defmodule Sqlcommenter.Repo do
    ...
    defdelegate all_running(), to: Ecto.Repo
    ...
    defmacro __using__(opts) do
      quote bind_quoted: [opts: opts] do
          ...
          [
            comment:
              Sqlcommenter.Commenter.to_str(
                @sqlcommenter ++
                  [
                    module: get_module(caller.module),
                    function: get_function(caller.function),
                    line: caller.line
                  ]
              )
          ]
        ...
        defp get_function({function, arity}), do: "#{function}/#{arity}"
        defp get_function(_), do: nil

        defp get_module(module) when is_atom(module) and module != nil do
          module
          |> Atom.to_string()
